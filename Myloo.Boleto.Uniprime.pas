...
type
  ...
  TBancoUniprime = class(TBancoClass)
  private
    FBoleto: TBoleto;
...
constructor TBancoUniprime.create(AOwner: TBanco);
begin
...
function TBancoUniprime.CalcularDigitoVerificador(const Titulo: TTitulo ): String;
begin
...
function TBancoUniprime.MontarCodigoBarras ( const Titulo: TTitulo) : String;
var
...
procedure TBancoUniprime.GerarRegistroHeader400(NumeroRemessa : Integer; ARemessa:TStringList);
var
  wLinha: String;
begin
...
procedure TBancoUniprime.GerarRegistroTransacao400(Titulo :TTitulo; aRemessa: TStringList);
var
...
begin
   ...
   begin
      ...
      if (Boleto.Cedente.ResponEmissao = tbBancoEmite) and (StrToIntDef(ANossoNumero,0) = 0) then
        DigitoNossoNumero := '0'
      else
      begin
...
procedure TBancoUniprime.GerarRegistroTrailler400( ARemessa:TStringList );
var
  wLinha: String;
begin
...
Procedure TBancoUniprime.LerRetorno400 ( ARetorno: TStringList );
var
  Titulo : TTitulo;
...
function TBancoUniprime.TipoOcorrenciaToDescricao(const TipoOcorrencia: TTipoOcorrencia): String;
var
...
function TBancoUniprime.CodOcorrenciaToTipo(const CodOcorrencia:
...
function TBancoUniprime.TipoOcorrenciaToCod ( const TipoOcorrencia: TTipoOcorrencia ) : String;
begin
  Result := '';
...
function TBancoUniprime.COdMotivoRejeicaoToDescricao( const TipoOcorrencia:TTipoOcorrencia ;CodMotivo: Integer) : String;
begin
   case TipoOcorrencia of
...
procedure TBancoUniprime.LerRetorno240(ARetorno: TStringList);
var
  Titulo: TTitulo;
...
function TBancoUniprime.CodOcorrenciaToTipoRemessa(const CodOcorrencia:Integer): TTipoOcorrencia;
begin
  case CodOcorrencia of

unit Myloo.Boleto.BancoBanestes;
...
type
  ...
  TBancoBanestes = class(TBancoClass)
  private
    FASBACE: string;
    FBoleto: TBoleto;
...
constructor TBancoBanestes.create(AOwner: TBanco);
begin
...
function TBancoBanestes.CalcularCampoASBACE(
...
begin
  ...
  cLivreAsbace := copy(Titulo.NossoNumero,1,8)                       +
                  copy(trim(Titulo.Boleto.Cedente.Conta), 1, 11) +
                  IfThen(titulo.Boleto.Cedente.Modalidade = '',
                         '4', titulo.Boleto.Cedente.Modalidade)  +
...
function TBancoBanestes.CalcularDigitoVerificador(const Titulo: TTitulo ): String;
var
...
begin
   ...
   Modulo.Documento := Titulo.NossoNumero+AdigitoNossoNumero;
   Modulo.Calcular;
   Result:= AdigitoNossoNumero+inttostr(Modulo.DigitoFinal);
end;

function TBancoBanestes.MontarCodigoBarras ( const Titulo: TTitulo) : String;
var
...
function TBancoBanestes.MontarCampoNossoNumero (
   const Titulo: TTitulo ) : String;
begin
   Result := Titulo.NossoNumero+'-'+CalcularDigitoVerificador(Titulo);
end;

function TBancoBanestes.MontarCampoCodigoCedente (
   const Titulo: TTitulo ) : String;
begin
...
procedure TBancoBanestes.GerarRegistroHeader400(NumeroRemessa: Integer; aRemessa: TStringList );
var
  wLinha: String;
begin
...
procedure TBancoBanestes.GerarRegistroTrailler400(ARemessa: TStringList);
var
  wLinha: String;
begin
...
procedure TBancoBanestes.GerarRegistroTransacao400(Titulo: TTitulo; aRemessa: TStringList);
var
...
function TBancoBanestes.GetASBACE: string;
begin
...
procedure TBancoBanestes.LerRetorno400(ARetorno: TStringList);
var
  ContLinha: Integer;
  Titulo   : TTitulo;
...
function TBancoBanestes.TipoOcorrenciaToDescricao(
...
function TBancoBanestes.CodOcorrenciaToTipo(
...
function TBancoBanestes.TipoOCorrenciaToCod(
  const TipoOcorrencia: TTipoOcorrencia): String;
begin
  Result := '';
...
function TBancoBanestes.CodMotivoRejeicaoToDescricao(

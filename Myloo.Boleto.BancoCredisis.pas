unit Myloo.Boleto.BancoCredisis;
...
const
  CBancoCredisis_Versao = '0.0.1';

type
  { TBancoCredisis}

  TBancoCredisis = class(TBancoClass)
   protected
   private
    FBoleto: TBoleto;
...
uses
  DateUtils, StrUtils, Variants, Math, Myloo.Boleto.Utils, Myloo.Validador;

constructor TBancoCredisis.create(AOwner: TBanco);
begin
...
function TBancoCredisis.CalcularDigitoVerificador(const Titulo: TTitulo): string;
begin
  Modulo.CalculoPadrao;
  Modulo.Documento := Titulo.NossoNumero;
  Modulo.Calcular;
...
function TBancoCredisis.FormataNossoNumero(const Titulo :TTitulo): String;
var
...
function TBancoCredisis.MontarCodigoBarras(const Titulo : TTitulo): String;
var
  CodigoBarras, FatorVencimento, DigitoCodBarras :String;
  ANossoNumero, AConvenio: String;
  {wTamNossNum: Integer;}
begin
   ANossoNumero := MontarCampoNossoNumero(Titulo);
...
function TBancoCredisis.MontarCampoCodigoCedente (
...
function TBancoCredisis.MontarCampoCarteira(const Titulo: TTitulo
  ): String;
begin
...
function TBancoCredisis.MontarCampoNossoNumero (const Titulo: TTitulo ) : String;
var
  ANossoNumero :string;
  aAgencia, aConvenio :string;
begin
  ANossoNumero := PadLeft(Titulo.NossoNumero, 6, '0');
  aAgencia     := PadLeft(OnlyNumber(Banco.Boleto.Cedente.Agencia), 4, '0');
  aConvenio    := PadLeft(OnlyNumber(Banco.Boleto.Cedente.Convenio), 6, '0');
  Result := IntToStrZero(Banco.Numero, 3) + CalcularDigitoVerificador(Titulo) + aAgencia + aConvenio + ANossoNumero;
end;

function TBancoCredisis.GerarRegistroHeader240(NumeroRemessa : Integer): String;
var
...
function TBancoCredisis.GerarRegistroTransacao240(Titulo : TTitulo): String;
var
...
function TBancoCredisis.GerarRegistroTrailler240( ARemessa : TStringList ): String;
begin
...
procedure TBancoCredisis.GerarRegistroHeader400(NumeroRemessa: Integer; aRemessa:TStringList);
var
...
procedure TBancoCredisis.GerarRegistroTransacao400(Titulo: TTitulo; aRemessa: TStringList);
var
...
procedure TBancoCredisis.GerarRegistroTrailler400(
...
procedure TBancoCredisis.LerRetorno240(ARetorno: TStringList);
var
  Titulo: TTitulo;
...
function TBancoCredisis.TipoOCorrenciaToCod (
...
function TBancoCredisis.TipoOcorrenciaToDescricao(const TipoOcorrencia: TTipoOcorrencia): String;
var
...
function TBancoCredisis.CodOcorrenciaToTipo(const CodOcorrencia:
...
function TBancoCredisis.CodMotivoRejeicaoToDescricao(const TipoOcorrencia: TTipoOcorrencia; CodMotivo: Integer): String;
begin
...
procedure TBancoCredisis.LerRetorno400(ARetorno: TStringList);
var
 TamConvenioMaior6: Boolean;
begin
...
procedure TBancoCredisis.LerRetorno400Pos6(ARetorno: TStringList);
var
  Titulo : TTitulo;
...
procedure TBancoCredisis.LerRetorno400Pos7(ARetorno: TStringList);
var
  Titulo : TTitulo;

...
begin
   ...
   begin
     Result:= IntToStr(Banco.NumeroCorrespondente)           + //001 a 003 - Código do banco SICOOB
...
begin
  ...
  wLinhaP:= '0000000'                                               +  // 001 a 007 - ZEROS
            ...
            ' '                                                     +  // 062       - Branco
            PadLeft(Titulo.SeuNumero , 15, ' ')                 +  // 063 a 077 - Seu Número
            ...
            '  '                                                    +  // 108 a 109 - Brancos
            FormatDateTime('ddmmyyyy',Titulo.DataProcessamento) +  // 110 a 117 - Data de emissão
  ...
  wLinhaQ := '0000000'                                                     +  // 001 a 007 - ZEROS
             ...
             PadLeft(OnlyNumber(Titulo.Sacado.CNPJCPF),14,'0')         +  // 020 a 033 - Número da inscrição do pagador
             ...
             PadRight(Titulo.Sacado.SacadoAvalista.CNPJCPF, 14, '0')   +  // 155 a 169 - Número de inscrição Sacado

unit Myloo.Boleto.BancoUnicredES;
...
type
  ...
  TBancoUnicredES = class(TBancoClass)
  private
    FBoleto: TBoleto;
    property Boleto:TBoleto read FBoleto write Fboleto;
    Function CodMultaToStr(const pCodigoMulta : TCodigoMulta): String;
    Function CodJurosToStr(const pCodigoJuros : TCodigoJuros; ValorMoraJuros : Currency): String;
    Function CodTipoOcorrenciaToStr(const pTipoOcorrencia : TTipoOcorrencia): String;
    Function CodDescontoToStr(const pCodigoDesconto : TCodigoDesconto): String;
  protected
  public
...
constructor TBancoUnicredES.create(AOwner: TBanco);
begin
...
function TBancoUnicredES.CalcularDigitoVerificador(const Titulo: TTitulo ): String;
begin
...
function TBancoUnicredES.MontarCodigoBarras ( const Titulo: TTitulo) : String;
var
...
begin
   ...
   begin
      ...
      sCodigoBarras     := IntToStrZero(Numero, 3) +                                              { Instituição Financ }
                           ...
                           Titulo.NossoNumero +                                               { Campo Livre 3 - Nosso Núm }
                           CalcularDigitoVerificador(Titulo);                                 {                C/ Dígito }
...
function TBancoUnicredES.MontarCampoNossoNumero (
   const Titulo: TTitulo ) : String;
begin
   Result := Titulo.NossoNumero + '-'+ CalcularDigitoVerificador(Titulo);
end;

function TBancoUnicredES.MontarCampoCodigoCedente (
   const Titulo: TTitulo ) : String;
begin
...
procedure TBancoUnicredES.GerarRegistroHeader400(NumeroRemessa : Integer; ARemessa:TStringList);
var
  wLinha: String;
begin
...
procedure TBancoUnicredES.GerarRegistroTransacao400(Titulo :TTitulo; aRemessa: TStringList);
var
   ...
   begin
      ...
      begin
         ...
         sLinha:= '1'                                                           +//'|'+  { 001 a 001  	Identificação do Registro }
                  ...
                  PadRight(Titulo.SeuNumero, 25, ' ')                       +//'|'+  { 038 a 062	  Nº Controle do Participante (Uso da empresa) 	025 }
                  ...
                  PadRight(Titulo.SeuNumero, 10)                            +//'|'+  { 111 a 120	  Nº do Documento (Seu número)	010 }
...
procedure TBancoUnicredES.GerarRegistroTrailler400( ARemessa:TStringList );
var
  wLinha: String;
begin
...
Procedure TBancoUnicredES.LerRetorno400 ( ARetorno: TStringList );
var
  vTitulo                     : TTitulo;
...
function TBancoUnicredES.TipoOcorrenciaToDescricao(const TipoOcorrencia: TTipoOcorrencia): String;
var
...
function TBancoUnicredES.CodOcorrenciaToTipo(const CodOcorrencia:
...
function TBancoUnicredES.TipoOcorrenciaToCod ( const TipoOcorrencia: TTipoOcorrencia ) : String;
begin
  Result := '';
...
function TBancoUnicredES.CodDescontoToStr(
  const pCodigoDesconto: TCodigoDesconto): String;
begin
...
function TBancoUnicredES.CodJurosToStr(const pCodigoJuros : TCodigoJuros; ValorMoraJuros : Currency): String;
begin
...
function TBancoUnicredES.COdMotivoRejeicaoToDescricao( const TipoOcorrencia:TTipoOcorrencia ;CodMotivo: Integer) : String;
begin
   case TipoOcorrencia of
...
function TBancoUnicredES.CodMultaToStr(const pCodigoMulta: TCodigoMulta): String;
begin
...
function TBancoUnicredES.CodOcorrenciaToTipoRemessa(const CodOcorrencia:Integer): TTipoOcorrencia;
begin
  case CodOcorrencia of
...
function TBancoUnicredES.CodTipoOcorrenciaToStr(const pTipoOcorrencia: TTipoOcorrencia): String;
begin

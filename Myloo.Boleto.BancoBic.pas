...
type
  ...
  public
    ...
    Function CalcularDigitoVerificadorArquivo(const Titulo:TTitulo): String;
...
constructor TBancoBic.create(AOwner: TBanco);
begin
...
function TBancoBic.CalcularDigitoVerificador(const Titulo: TTitulo ): String;
begin
   Modulo.CalculoPadrao;
   Modulo.MultiplicadorFinal := 7;
   Modulo.Documento := Titulo.Carteira +
                       Copy(Titulo.Boleto.Cedente.Modalidade,2,2) +
...
function TBancoBic.MontarCodigoBarras ( const Titulo: TTitulo) : String;
var
...
function TBancoBic.MontarCampoNossoNumero (
...
function TBancoBic.MontarCampoCodigoCedente (
   const Titulo: TTitulo ) : String;
begin
...
procedure TBancoBic.GerarRegistroHeader400(NumeroRemessa : Integer; ARemessa:TStringList);
var
  wLinha: String;
begin
...
procedure TBancoBic.GerarRegistroTransacao400(Titulo :TTitulo; aRemessa: TStringList);
var
...
begin
   ...
   with Titulo do
   begin
      DigitoNossoNumero := CalcularDigitoVerificadorArquivo(Titulo);
...
procedure TBancoBic.GerarRegistroTrailler400( ARemessa:TStringList );
var
  wLinha: String;
begin
...
function TBancoBic.TipoOcorrenciaToDescricao(const TipoOcorrencia: TTipoOcorrencia): String;
var
...
function TBancoBic.CodOcorrenciaToTipo(const CodOcorrencia:
...
function TBancoBic.CodOcorrenciaToTipoRemessa(const CodOcorrencia: Integer): TTipoOcorrencia;
begin
  case CodOcorrencia of
...
function TBancoBic.TipoOcorrenciaToCod ( const TipoOcorrencia: TTipoOcorrencia ) : String;
begin
...
function TBancoBic.CalcularDigitoVerificadorArquivo(
  const Titulo: TTitulo): String;
begin
   Modulo.CalculoPadrao;
   Modulo.MultiplicadorFinal := 9;
   Modulo.Documento := Titulo.Boleto.Cedente.Modalidade + Titulo.NossoNumero;
   Modulo.Calcular;
...
function TBancoBic.COdMotivoRejeicaoToDescricao( const TipoOcorrencia:TTipoOcorrencia ;CodMotivo: Integer) : String;
begin
   case TipoOcorrencia of
